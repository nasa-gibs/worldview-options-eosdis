<<<<<<< HEAD
The CERES Surface Shortwave Flux (Monthly, Energy Balanced and Filled, Up, Clear-Sky) layer show the EBAF Monthly Mean parameterized broadband shortwave (0.2-5 µm) upwelling (up, defined as positive) flux at the Earth’s surface, for clear-sky conditions (W/m<sup>2</sup>). CERES footprints (20 km nominal resolution) are classified as clear if they contain 99% of pixels identified as clear by the CERES-MODIS clear-sky mask.
=======
### Surface Shortwave Flux (Monthly, Energy Balanced and Filled, Up, Clear-Sky)
