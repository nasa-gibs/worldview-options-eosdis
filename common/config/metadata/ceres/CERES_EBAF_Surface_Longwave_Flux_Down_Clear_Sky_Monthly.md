<<<<<<< HEAD
The CERES Surface Longwave Flux (Monthly, Energy Balanced and Filled, Down, Clear-Sky) layer show the EBAF Monthly Mean parameterized broadband thermal longwave (3.5-50 µm) downwelling (down, defined as positive flux at the Earth’s surface, for clear-sky conditions (W/m<sup>2</sup>). CERES footprints (20 km nominal resolution) are classified as clear if they contain 99% of pixels identified as clear by the CERES-MODIS clear-sky mask.
=======
### Surface Longwave Flux (Monthly, Energy Balanced and Filled, Down, Clear-Sky)
