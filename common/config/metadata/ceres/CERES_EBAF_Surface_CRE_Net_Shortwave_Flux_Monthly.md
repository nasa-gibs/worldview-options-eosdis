### Surface CRE Net Shortwave Flux (Monthly, Energy Balanced and Filled)
Temporal coverage: March 2000 - December 2016

The CERES Surface CRE Net Shortwave Flux layer shows Energy Balanced and Filled (EBAF) Monthly Mean Flux (w/m<sup>2</sup>), for the shortwave (0.2-5 µm) broadband wavelength at the earth’s surface corresponding to Cloud Radiative Effects (CRE). CRE, also referred to as cloud forcing, is defined for surface measurements as the difference between all-sky and clear-sky pixels. Net flux is the sum of the incoming and outgoing radiative fluxes at the surface, corresponding to the specified spectral band.
